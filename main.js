...
function INSERT(){
  ...
  function Display(){
      ...
      for(var i=0;i<Students.length;i++){
          temp+="<tr><td>"+Students[i].Name+"</td> <td>"+Students[i].ID+"</td> <td>"+Students[i].GPA+"</td> <td>"+Students[i].birth +"</td><td><button class='btn btn-danger' onclick='Delete("+i+");'>"+"Delete"+"</button></td><td><button class='btn btn-warning' onclick='Update("+i+");'>" + "Edit" +"</button></td></tr>"
